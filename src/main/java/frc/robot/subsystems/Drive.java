...
public class Drive extends SubsystemBase {
    ...
    static final double turnGain = 2.0;
    static final double deadband = .15;
    static final double driveGain = 2.0;
    ...
    */
    public Drive() {
        ...
        rightFollower = new WPI_VictorSPX(DriveConstants.kLeftFollowerPort);

        rightSideDrive = new MotorControllerGroup(rightLeader, rightFollower);
        addChild("rightSideDrive", rightSideDrive);

        differentialDrive = new DifferentialDrive(leftSideDrive, leftLeader);
