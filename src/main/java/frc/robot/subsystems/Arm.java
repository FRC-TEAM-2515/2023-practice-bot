...
private double kJ4RampRate = 4;
private double kJ5RampRate = 4;
...
protected XboxController armController;
    ...
    public void periodic() {
        ...
        double j5RampRate = SmartDashboard.getNumber("J5 Ramp Rate", 4);
        ...
        if((j5RampRate != kJ5RampRate)) {
            kJ5RampRate = j5RampRate; }
        ...
        SmartDashboard.putNumber("Applied J3 Ramp Rate", j3WristY.getOpenLoopRampRate());
        SmartDashboard.putNumber("Applied J4 Ramp Rate", j4WristX.getOpenLoopRampRate());
        SmartDashboard.putNumber("Applied J5 Ramp Rate", j5Claw.getOpenLoopRampRate());
